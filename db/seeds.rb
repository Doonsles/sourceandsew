...
f6 = Factory.create({:phone => "456-789-0123",  :description => "Making someone's favorite shirt", 
...
f7 = Factory.create({:phone => "456-789-0123",  :description => "Divine Apparel, Inc.", 
...
f8 = Factory.create({:phone => "456-789-0123",  :description => "Quality. Guaranteed.", 
...
f9 = Factory.create({:phone => "456-789-0123",  :description => "New York City-based apparel manufacturer and full service marketing agency.", 
...
f10 = Factory.create({:phone => "456-789-0123",  :description => "From concept to patterns, samples, sourcing, and production starting at 100 units", 
...
f11 = Factory.create({:phone => "456-789-0123",  :description => "A Premier Manufacturer and Merchandiser of Quality since 1931.", 
